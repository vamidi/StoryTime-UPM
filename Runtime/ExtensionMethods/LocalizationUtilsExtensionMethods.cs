...
namespace StoryTime.Extensions.Localization
{
	public static class LocalizationUtilsExtensionMethods
	{
		...
		public static string GetLocalizedStringImmediateSafe(this LocalizedString localizedStringReference)
		{
			...
			{
				var tableCollection =
					LocalizationEditorSettings.GetStringTableCollection(localizedStringReference.TableReference);
				...
				if (locale != null)
				{
					...
					if (table != null)
						if (table.GetEntryFromReference(localizedStringReference.TableEntryReference) != null)
							text = table.GetEntryFromReference(localizedStringReference.TableEntryReference)
								.LocalizedValue;
				}
			}
