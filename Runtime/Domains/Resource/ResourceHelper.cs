...
namespace StoryTime.Domains.Resource
{
	public static class ResourceHelper
	{
		...
		/// <summary>
		/// Get an asset from the destination path.
		/// Make relative if convert is true. This is needed for loading scriptable objects.
		/// </summary>
		...
		public static void SaveAsset(ScriptableObject file)
		{
		...
		{
			return UnityEngine.AddressableAssets.Addressables.LoadAssetAsync<T>(address);
		}
