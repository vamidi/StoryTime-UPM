...
namespace StoryTime.Domains.Game.Characters.Players
{
    ...
    using StoryTime.Domains.Game.Abilities;
    using StoryTime.Domains.SceneManagement;
    using StoryTime.Domains.Game.DamageSystem;
    using StoryTime.Domains.Game.NPC.Enemies.Behaviours;
    using StoryTime.Domains.SceneManagement.SpawnSystems;
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        public void OnReceiveMessage(MessageType type, Damageable.DamageMessage damageData)
        {
            switch (type)
            {
