...
{
	using StoryTime.Domains.Game.UI;
	...
	using StoryTime.Domains.SceneManagement.RunTimeAnchors;
	...
	/// </summary>
	public class ExampleSpawnSystem : BaseSpawnSystem
	{
		...
		private PlayerController InstantiatePlayer(PlayerController playerControllerPrefab, Transform spawnLocation)
		{
			...
			PlayerController playerInstance =
				Instantiate(playerControllerPrefab, spawnLocation.position, spawnLocation.rotation);
