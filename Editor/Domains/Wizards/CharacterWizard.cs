...
namespace StoryTime.Editor.Domains.Wizards
{
	...
	public class CharacterWizard : BaseWizard<CharacterWizard, CharacterSO>
	{
		...
		[SerializeField, Tooltip("Equipment of the character")] protected string className = "";
		...
		protected override CharacterSO Create(string location)
		{
			...
			AssetDatabase.CreateAsset(characterClass, $"{folderPath}/{withoutExtension}_{className}.asset");
